...
import { Eye, EyeOff, MapPin, ArrowRight, User, Mail, Lock, Sparkles, Heart, Globe, Shield, Star, Mountain } from "lucide-react"
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('/buddhist-monks-meditation-hall-candles.jpg')] bg-cover bg-center opacity-20"></div>
          <div className="absolute inset-0 bg-gradient-to-br from-emerald-600/80 via-teal-600/70 to-cyan-700/80"></div>
        ...
        {mounted && (
          <>
            ...
            <div className="absolute top-40 right-20 opacity-40 animate-float-delayed">
              <Globe className="h-10 w-10 text-emerald-300/80" />
            </div>
        ...
        <div className="relative z-10 flex flex-col justify-center items-center p-12 text-white">
          <div className="max-w-md text-center">
            ...
            <div className="mb-8">
              ...
              <p className="text-white/90 text-lg">Begin Your Spiritual Journey</p>
            </div>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-center gap-4 text-left">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">Complete access to all features</p>
                </div>
              </div>
              <div className="flex items-center gap-4 text-left">
                <div className="w-12 h-12 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">Connect with fellow seekers</p>
                </div>
              </div>
              <div className="flex items-center gap-4 text-left">
                <div className="w-12 h-12 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">Tailored spiritual guidance</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <blockquote className="text-white/90 italic text-lg leading-relaxed">
                Every soul is a sacred journey waiting to unfold.
              </blockquote>
      ...
      <div className="flex-1 flex items-center justify-center p-4 lg:p-8 bg-gradient-to-br from-background via-muted/20 to-background relative overflow-hidden">
        ...
        <div className="lg:hidden absolute inset-0">
          <div className="absolute inset-0 bg-[url('/buddhist-monks-meditation-hall-candles.jpg')] bg-cover bg-center opacity-5"></div>
        ...
        {mounted && (
          <>
            ...
            <div className="lg:hidden absolute top-20 right-20 opacity-20 animate-float-delayed">
              <Globe className="h-8 w-8 text-accent/60" />
            </div>
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="text-center mb-6 animate-fade-in-up">
            <Link href="/" className="inline-flex items-center gap-3 group">
              ...
              <div className="text-left">
                ...
                <span className="block text-xs text-muted-foreground font-medium">Join the Community</span>
              </div>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6 animate-fade-in-up delay-100">
            <div className="text-center p-3 bg-card/80 backdrop-blur-sm rounded-lg border border-border/20 shadow-sm">
              <Globe className="h-5 w-5 text-primary mx-auto mb-1" />
              <div className="text-xs text-muted-foreground font-medium">Explore 2.5K+ Monasteries</div>
            </div>
            <div className="text-center p-3 bg-card/80 backdrop-blur-sm rounded-lg border border-border/20 shadow-sm">
              <Heart className="h-5 w-5 text-accent mx-auto mb-1" />
              <div className="text-xs text-muted-foreground font-medium">Join 15K+ Travelers</div>
            </div>
          </div>
          ...
          <Card className="bg-card/95 backdrop-blur-lg border-border/50 shadow-xl animate-fade-in-up delay-200">
            <CardHeader className="text-center space-y-2 relative pb-4">
              ...
              <CardDescription className="text-muted-foreground text-sm">
                Join thousands of spiritual seekers on their sacred journey
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6 p-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {formData.password && (
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <Progress value={passwordStrength} className="flex-1 h-1.5" />
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    ...
                    />
                    <Shield className={`absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 transition-colors duration-300 ${
              ...
              <div className="text-center text-sm pt-4">
                ...
                <Link href="/auth/login" className="text-primary hover:text-primary/80 font-medium hover:underline transition-colors duration-200">
                  Sign in here
                </Link>
              </div>
            </CardContent>
